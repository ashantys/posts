...
<body class="bg-white font-family-karla">
    ...
    <!-- Top Bar Nav -->
    <nav class="fixed w-full top-0 py-4 bg-blue-800 shadow z-50">
    ...
    <!-- Text Header -->
    <header class="mt-12 w-full container mx-auto">
        ...
        <section class="w-full md:w-2/3 flex flex-col items-center px-3">
            ...
            <article class="flex flex-col shadow my-4">
                ...
                <div class="bg-white flex flex-col justify-start p-6">
                    ...
                    <a href="/{{ $post->slug }}" class="pb-6">{!! \Illuminate\Support\Str::limit($post->body, 150, '...') !!}</a>
